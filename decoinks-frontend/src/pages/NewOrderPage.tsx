    ...
    <div className="no-page">
      ...
      <div className="no-body no-body-cols">
        ...
        <div className="no-sidebar">
          ...
          {/* Payment Information now lives in its own Payments module (sidebar →
              Payments), so an order is not the place to capture money. The
              order's stored payment fields are untouched and still drive the
              Dashboard KPIs and the Paid Amount column on the orders list. */}
          <div className="no-card no-payment-card">
            <h4 className="no-section-title">Payment</h4>
            <p style={{ fontSize: 12.5, color: '#64748b', lineHeight: 1.6, margin: '0 0 10px' }}>
              Payments are recorded in the Payments module and linked to this order.
            </p>
            <button type="button" className="no-topbar-btn" onClick={() => navigate('/payments')}>
              Go to Payments
            </button>
          </div>
        </div>
