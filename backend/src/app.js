...
const supplierOrderRoutes = require('./modules/supplier-orders/supplierOrders.routes')
...
app.use('/api/supplier-orders', supplierOrderRoutes)   // DIGI orders — Supplier Order Management
app.use('/api/notifications', notificationRoutes)     // header bell + phone push (migration 154)
