...
/**
 * Purchase Orders — the plain list of every PO shared with this supplier.
 * Supplier Management (/purchase-orders) is the operational grid; this is the
 * simple document list, without prices (no money reaches a supplier).
 */
